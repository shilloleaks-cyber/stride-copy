...
// Notched tear-line separator
function TearLine() {
  return (
    <div style={{ position: 'relative', display: 'flex', alignItems: 'center', margin: '0', padding: '0 0' }}>
