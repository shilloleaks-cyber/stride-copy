...
import { Play, TrendingUp, MapPin, Flame, Clock, Heart, Activity } from 'lucide-react';
      ...
      <div className="px-6 mb-8">
        <Link to={createPageUrl('ActiveRun')}>
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className="relative overflow-hidden bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-3xl p-6 shadow-2xl shadow-emerald-500/20"
          >
